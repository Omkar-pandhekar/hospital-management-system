    ...
    <main class="card-container slideUp-animation">
        ...
        <form method="post" action="func1.php">
            <div class="form-container slideRight-animation">
                <h1 class="form-header">Hello Doctor !</h1>

                <div class="input-container">
                    <label for="f-name"></label>
                    <input type="text" name="username3" onkeydown="return alphaOnly(event);" required />
                    <span>Username</span>
                    <div class="error"></div>
                </div>
                ...
                <div id="btm">
                    <button type="submit" class="submit-btn" name="docsub1">
                        Login
                    </button>
                </div>
            </div>
